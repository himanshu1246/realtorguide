...
export function Production({ onEnquiry }: { onEnquiry?: () => void }) {
  ...
  return (
    <section className="production relative" id="production" style={{ background: "#0f0f11", padding: "100px 0", overflow: "hidden" }}>
      <div className="absolute top-[-100px] right-[-100px] w-[500px] h-[500px] rounded-full blur-[100px] pointer-events-none" style={{ background: "rgba(139,92,246,0.15)" }} />
      
      <div className="container mx-auto px-6 relative z-10">
        <div className="reveal py-12 text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-6">
            <span className="w-10 h-[2px]" style={{ background: "linear-gradient(90deg, #8B5CF6, transparent)" }} />
            <span className="text-xs md:text-sm font-semibold uppercase tracking-[0.2em]" style={{ color: "#8B5CF6" }}>
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 leading-tight" style={{ color: "white", fontFamily: "Syne, sans-serif" }}>
            Content That Sells <span style={{ color: "#8B5CF6" }}>Properties.</span>
          </h2>
      ...
      <div className="relative w-full flex flex-col items-center overflow-hidden pb-24" style={{ perspective: "1500px" }}>
        <div className="relative w-full max-w-[1000px] h-[500px] flex justify-center items-center">
          {videos.map((video, index) => {
            ...
            const translateX = isActive ? 0 : direction * (160 + (absDiff > 1 ? (absDiff - 1) * 120 : 0));
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow: isActive ? "0 25px 50px rgba(139,92,246,0.4)" : "0 15px 35px rgba(0,0,0,0.4)",
        ...
        <div className="flex items-center justify-between bg-[#1f2125] border border-white/10 rounded-[40px] p-2 w-full max-w-[340px] mt-8 z-20 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
          ...
          <div className="flex items-center gap-3 px-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[#8B5CF6] text-[0.7rem] font-medium">{activeVideo.category}</span>
            </div>
          </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 z-[3] pointer-events-none">
        <svg viewBox="0 0 1440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="block w-full h-auto">
          <path d="M0 60L48 54C96 48 192 36 288 36C384 36 480 48 576 54C672 60 768 60 864 54C960 48 1056 36 1152 30C1248 24 1344 24 1392 24L1440 24V120H1392C1344 120 1248 120 1152 120C1056 120 960 120 864 120C768 120 672 120 576 120C480 120 384 120 288 120C192 120 96 120 48 120H0V60Z" fill="#F8F6FF"/>
        </svg>
      </div>
    </section>
  );
...
fs.writeFileSync('src/components/sections/Production.tsx', content, 'utf8');
console.log('Successfully updated Production.tsx');
